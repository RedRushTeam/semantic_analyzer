...
{
	for (auto obj_of_cont_class : this->list_of_container_class)	//áîëüøóþ ÷àñòü âðåìåíè çàíèìàåò èìåííî ýòî äåéñòâèå, âîçìîæíî, åãî ìîæíî ñäåëàòü "çàðàíåå"
...
{
	for (auto obj_of_cont_class : this->list_of_container_class)	//2/3 âðåìåíè óõîäèò íà ýòî äåéñòâèå
