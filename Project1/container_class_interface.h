...
public:
	...
	container_class_interface(unsigned short int counter_of_tokenizer, int k, type_of_cont_class _type_of_cont_class, fs::path filename) : counter_of_tokenizer(counter_of_tokenizer), k(k), _type_of_cont_class(_type_of_cont_class), filename(filename)	{  }
	container_class_interface(int k, type_of_cont_class _type_of_cont_class, fs::path filename) : k(k), _type_of_cont_class(_type_of_cont_class), filename(filename) {  }
